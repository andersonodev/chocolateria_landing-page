      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <button
              className="md:hidden text-coffee-800 hover:text-coffee-600 transition-colors duration-200"
      ...
      <footer className="bg-coffee-800 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="font-serif text-3xl mb-6">Sabor e Prazer</h3>
              <p className="text-coffee-100 text-lg">
                Chocolateria artesanal desde 2017
              </p>
            </div>
            <div>
              <h4 className="font-serif text-2xl mb-6">Contato</h4>
            ...
            <div>
              <h4 className="font-serif text-2xl mb-6">Siga-nos</h4>
              <div className="flex space-x-6">
                <a 
                  href="https://facebook.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white hover:text-coffee-200 transition-colors duration-300 transform hover:scale-110"
                >
          ...
          <div className="border-t border-coffee-700 mt-12 pt-8 text-center text-coffee-100">
